...
public class Test01 {
    public static void main(String[] args) {
        ...
        HeroNode hero5 = new HeroNode(3, "关羽", "汉寿亭侯");
        HeroNode hero6 = new HeroNode(4, "张飞", "燕人张飞");
        HeroNode hero7 = new HeroNode(6, "赵云", "子龙浑身是胆");
        ...
        // HeroNode reserveNode = linkedList.convertLink();
        ...
        linkedList2.list();
        HeroNode merge = SingleLinkedList.merge(linkedList.getHead(), linkedList2.getHead());
